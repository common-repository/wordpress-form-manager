...
<form enctype="multipart/form-data" name="fm-main-form" id="fm-main-form" action="" method="post">
	...
	<?php
	$fmDataDateStart = isset( $_POST[ 'fm-data-date-start' ] ) ? $_POST[ 'fm-data-date-start' ] : "";
	$fmDataDateEnd = isset( $_POST[ 'fm-data-date-end' ] ) ? $_POST[ 'fm-data-date-end' ] : "";
	?>
	...
	<?php
	$fmDataSearch = isset( $_POST[ 'fm-data-search' ] ) ? $_POST[ 'fm-data-search' ] : "";
	$fmDataSearchColumn = isset( $_POST[ 'fm-data-search-column' ] ) ? $_POST[ 'fm-data-search-column' ] : "";
	?>
	...
	<?php
	$fmDataSortBy = isset( $_POST['fm-data-sort-by'] ) ? $_POST['fm-data-sort-by'] : "";
	$fmDataSortOrder = isset( $_POST['fm-data-sort-order'] ) ? $_POST['fm-data-sort-order'] : "asc";
	?>
